...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { name: @gallery.name, published: @gallery.published } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { name: @gallery.name, published: @gallery.published } }
